...
Noble.prototype.addPeripheral = function(uuid) {
  if (!this._discoveredPeripheralUUids) {
    this._discoveredPeripheralUUids = [];
    this._allowDuplicates = false;
  }

  var peripheral = new Peripheral(this, uuid, null, null);
  this._peripherals[uuid] = peripheral;
  this._services[uuid] = {};
  this._characteristics[uuid] = {};
  this._descriptors[uuid] = {};
  this._discoveredPeripheralUUids.push(uuid);
  this._bindings.addPeripheral(uuid);
